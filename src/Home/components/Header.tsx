        ...
        <div className="hidden md:flex items-center gap-10">
          ...
          {usuario ? (
            <button 
              ...
              className="flex items-center gap-3 bg-linear-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white px-5 py-2.5 rounded-md font-bold text-sm shadow-lg hover:shadow-xl transition-all active:scale-95"
            >
