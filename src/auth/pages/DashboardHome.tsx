            ...
            <>
              <Card hoverable className="border-l-4 border-purple-500">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    <p className="text-sm font-medium text-neutral-600">Disciplinas Totales</p>
                    <p className="text-3xl font-bold text-neutral-800 mt-1">0</p>
                  </div>
                </div>
              </Card>
              ...
              <Card hoverable className="border-l-4 border-red-500">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="text-3xl font-bold text-neutral-800 mt-1">1</p>
                  </div>
                </div>
              </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <button className="p-6 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl hover:shadow-lg transition-all text-left group">
              ...
              {activeRole === ROLES.STUDENT && (
                <button className="p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl hover:shadow-lg transition-all text-left group">
              ...
              {(activeRole === ROLES.MANAGER || activeRole === ROLES.SYSADMIN) && (
                <>
                  <button className="p-6 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl hover:shadow-lg transition-all text-left group">
                  ...
                  {activeRole === ROLES.SYSADMIN && (
                    <button className="p-6 bg-gradient-to-br from-red-50 to-red-100 rounded-xl hover:shadow-lg transition-all text-left group">
