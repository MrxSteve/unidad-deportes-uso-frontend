      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card hoverable className="border-l-4 border-secondary-500">
            <div className="flex items-center">
              <div className="p-4 bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-2xl shadow-lg shadow-secondary-500/30">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white rounded-xl p-4 border border-neutral-100 shadow-sm">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {usuario?.roles.map((rol) => (
                    <span
                      key={rol}
                      className="px-3 py-1.5 bg-gradient-to-r from-primary-500 to-primary-600 text-white text-sm font-semibold rounded-full shadow-md"
                    >
                      {rol}
                    </span>
                  ))}
