              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Cambia entre tus diferentes roles para acceder a distintas
                    funcionalidades
                  </p>
                </div>
          ...
          {showManagerContent && (
            <>
              <Card hoverable className="border-l-4 border-purple-500">
                <div className="flex items-center">
                  <div className="p-4 bg-linear-to-br from-purple-500 to-purple-600 rounded-2xl shadow-lg shadow-purple-500/30">
                    <svg
                      className="w-8 h-8 text-white"
                      fill="none"
                      stroke="currentColor"
          ...
          {showSysadminContent && (
            <>
              <Card hoverable className="border-l-4 border-red-500">
                <div className="flex items-center">
                  <div className="p-4 bg-linear-to-br from-red-500 to-red-600 rounded-2xl shadow-lg shadow-red-500/30">
                    <svg
                      className="w-8 h-8 text-white"
                      fill="none"
                      stroke="currentColor"
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Panel de gestión de disciplinas y eventos
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <button
                    onClick={() => navigate("/admin/usuarios")} // Reemplaza con tu ruta real de RolesPage
                    className="p-6 bg-linear-to-br from-red-50 to-red-100 rounded-xl hover:shadow-lg transition-all text-left group"
                  >
                    <svg
                      className="w-8 h-8 text-red-600 mb-3 group-hover:scale-110 transition-transform"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <button className="p-6 bg-linear-to-br from-indigo-50 to-indigo-100 rounded-xl hover:shadow-lg transition-all text-left">
                    <svg
                  ...
                  <button className="p-6 bg-linear-to-br from-green-50 to-green-100 rounded-xl hover:shadow-lg transition-all text-left">
                    <svg
                  ...
                  {usuario?.roles.map((rol) => (
                    <span
                      ...
                      className={`px-3 py-1.5 text-sm font-semibold rounded-full shadow-md ${
                        activeRole === rol
                          ? `bg-linear-to-r ${getRoleColor(rol)} text-white`
