          ...
          <div className="w-full max-w-sm flex flex-col items-center text-center">
            ...
            <div className="mb-10">
              <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight leading-tight">
                Bienvenido al Sistema Deportivo
              </h1>
            ...
            <div className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-5 flex items-center gap-6 shadow-sm">
              ...
              <div className="text-left">
                <p className="text-lg font-bold text-gray-800 leading-tight">Acceso Institucional</p>
                <p className="text-sm text-gray-500 mt-1.5 leading-relaxed">
                  Usa tu correo <span className="font-semibold text-blue-600">@usonsonate.edu.sv</span>
                </p>
              </div>
            </div>
            ...
            <div className="w-full mt-12 space-y-6">
              <p className="text-xs text-gray-400">
                Al ingresar aceptas los <a href="#" className="underline hover:text-gray-700 transition-colors">términos y condiciones</a>.
              </p>
              <div className="border-t border-gray-100 pt-8">
                <a href="#" className="inline-flex items-center text-sm font-semibold text-gray-500 hover:text-blue-600 transition-colors">
                  ¿Necesitas ayuda? <span className="ml-2 underline decoration-2 underline-offset-4">Soporte Técnico</span>
                </a>
              </div>
            </div>
