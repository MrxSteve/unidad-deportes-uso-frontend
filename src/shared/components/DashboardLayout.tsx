...
import { ROLES, getRoleLabel, getRoleColor, hasMultipleRoles } from "../../auth/utils/roleUtils";
            ...
            <div className="relative">
              ...
              >
                {usuario?.fotoUrl ? (
                  ...
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-secondary-500 to-secondary-600 flex items-center justify-center text-white font-bold text-sm">
      ...
      <div className="flex">
        ...
        >
          <nav className="p-4 space-y-2">
            ...
            {hasMultipleRoles(usuario) && isSidebarOpen && (
              <div className="md:hidden mb-4 pb-4 border-b border-neutral-200">
                <label className="block text-xs font-semibold text-neutral-600 mb-2">Cambiar Rol</label>
                <select
                  value={activeRole || ''}
                  onChange={(e) => setActiveRole(e.target.value)}
                  className="w-full px-3 py-2 text-sm font-semibold bg-neutral-50 border border-neutral-200 rounded-lg outline-none focus:ring-2 focus:ring-primary-500"
                >
                  {usuario?.roles.map((rol) => (
                    <option key={rol} value={rol}>
                      {getRoleLabel(rol)}
